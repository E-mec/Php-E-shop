            ...
            <div class="row mx-n2">
                ...
                <div class="col-md-4 col-sm-6 px-2 mb-4">
                    <div class="card product-card">
                        ...
                        <a class="card-img-top d-block overflow-hidden" href="product.php?id=<?= $product['id'] ?>">
                            <img src="<?= get_thumbnail($product['photos']) ?>" alt="Product"></a>
                        <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Sneakers &amp; Keds</a>
                            <h3 class="product-title fs-sm"><a href="product.php?id=<?= $product['id'] ?>"><?= $product['name'] ?></a></h3>
